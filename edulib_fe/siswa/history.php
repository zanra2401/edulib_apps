...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="http://localhost:8282/edulib/siswa/history.php">Riwayat</a>
                </li>
            ...
            bukus.forEach(element => {
                ...
                $(`<div class="card">
                    <div class="card-body d-flex p-0">
                        ...
                        >
                        <span class="p-3">
                            <h5 class="card-title">${element.judulBuku}</h5>
                            <span class="card-text text-warning">Penulis: ${element.penulis}</span>
                            <br>
                            <span class="card-text text-warning">Dipinjam: ${element.diPinjam}</span>
                            <br>
                            <span class="card-text text-warning">Kembali: ${element.kembali}</span>
                        </span>
                    </div>
    ...
    <script>
        $("document").ready(() => {
            $.ajax({
                url: "http://localhost:8080/edulib/buku/riwayat",
                type: "get",
                xhrFields: {
                    withCredentials: true,
                },
