...
<body>
    ...
    <div id="main-content" class="container-fluid p-4 d-flex flex-column gap-3">
        ...
        <div id="profile-info" class="d-flex gap-3">
            <span id="identitas">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" href="http://localhost:8282/edulib/siswa/dashboard.php" aria-current="page" href="#">Dipinjam</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="http://localhost:8282/edulib/siswa/dashboard-pengajuan.php">Pengajuan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="http://localhost:8282/edulib/siswa/dashboard-penolakan.php">Penolakan</a>
            </li>
        </ul>
                    ...
                    <div class="card-body d-flex p-0 h-full">
                        ...
                        <div class="d-flex flex-column justify-content-between p-2">
                            <span>
                                ...
                                <p class="card-text text-warning">Tenggat: ${element.tanggalTenggat}</p>
                            </span>
                            ${(element.terlambat) ? '<span class="badge text-bg-danger p-2" style="width: fit-content;">terlambat</span>' : '<span style="width: fit-content;" class="badge text-bg-warning p-2">dipinjam</span>'}
                        </div>
                    </div>
    ...
    <script>
        ...
        $("document").ready(() => {
            ...
            $.ajax({
                ...
                success: function (response) {
                    showBuku(response.buku.body.buku);
                },
                error: {
