    ...
    <div id="main-content" class="container-fluid p-4 d-flex flex-column gap-3">
        ...
        <div id="profile-info" class="d-flex gap-3 align-items-center">
            ...
            <div class="d-flex flex-column justify-content-center gap-0">
                <span id="nisn-tag" class="fw-bold">
                    24012005    
                </span>
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="http://localhost:8282/edulib/siswa/dashboard-pengajuan.php">Pengajuan</a>
            </li>
            <li class="nav-item">
            ...
            bukus.forEach(element => {
                ...
                $(`<div class="card">
                    <div class="card-body d-flex gap-2 p-0">
                        ...
                        >
                        <span class="py-2 d-flex flex-column justify-content-between">
                            <h5 class="card-title">${element.judul}</h5>
                            <p class="card-text text-warning">Penulis: ${element.penulis}</p>
                            <span class="badge text-bg-warning text-light p-2" style="width: fit-content;">Menunggu</span>
                        </span>
                    </div>
